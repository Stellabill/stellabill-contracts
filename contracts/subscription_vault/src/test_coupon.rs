...
fn test_apply_coupon_subscriber_auth() {
    ...
    let sub_id = client
        .mock_all_auths()
        .create_subscription(&subscriber, &merchant, &1000, &86400, &false, &None::<i128>, &None::<u64>, &None::<u32>);
...
fn test_apply_coupon_limit_reached() {
    ...
    let sub_id1 = client
        .mock_all_auths()
        .create_subscription(&subscriber1, &merchant, &1000, &86400, &false, &None::<i128>, &None::<u64>, &None::<u32>);
    let sub_id2 = client
        .mock_all_auths()
        .create_subscription(&subscriber2, &merchant, &1000, &86400, &false, &None::<i128>, &None::<u64>, &None::<u32>);
