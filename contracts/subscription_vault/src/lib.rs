...
pub use types::{
    ...
    NextChargeInfo, RecoveryReason, Subscription, SubscriptionCancelledEvent,
...
impl SubscriptionVault {
    ...
    pub fn estimate_topup_for_intervals(env: Env, subscription_id: u32) -> Result<i128, Error> {
        queries::estimate_topup_for_intervals(&env, subscription_id, 1)
    }
    /// Get estimated next charge info
